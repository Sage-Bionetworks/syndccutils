...
synproject_id <- "syn10345266" # Synapse project for project Center
project_id <- "syn9615696" # Synapse folder associated with project
parent_id <- "syn10518272" # Center 'Reporting' folder where files should be stored
master_fileview_id <- "syn9630847" # Synapse fileview associated with project
