...
synproject_id <- "syn6633069" # Synapse project for project Center
source_id <- "syn6633069" # Synapse folder associated with project
parent_id <- "syn11941351" # Center 'Reporting' folder where files should be stored
master_fileview_id <- "syn11614207" # Synapse fileview associated with project
