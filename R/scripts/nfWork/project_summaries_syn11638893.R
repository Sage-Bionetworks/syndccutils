...
synproject_id <- "syn11638893" # Synapse Project for project Center
consortium_id <- "syn4939478" # Synapse folder associated with consortium
parent_id <- "syn14780439" # Center 'Reporting' folder where files should be stored
master_fileview_id <- "syn11678418" # Synapse fileview associated with project
...
# summarize by assay
table_filename <- glue::glue("{source_id}_SpecimenCountsByAssay.html",
...
files_by_dataType_table_filename <- glue::glue("{source_id}_SpecimenCountsByDataType.html",
                                               source_id = source_id)
